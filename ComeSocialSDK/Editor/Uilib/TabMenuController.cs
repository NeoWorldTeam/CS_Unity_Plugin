...
public class TabMenuController
{
    ...
    */
    ...
    {
        return tab.ClassListContains(activeClassName);
    }

    private UQueryBuilder<Label> GetAllTabs()
    {
        return root.Query("tabs").Children<Label>();
    }
    ...
    {
        tab.AddToClassList(activeClassName);
        VisualElement content = FindContent(tab);
        content.AddToClassList(activeClassName);
    }
    ...
    {
        tab.RemoveFromClassList(activeClassName);
        VisualElement content = FindContent(tab);
        content.RemoveFromClassList(activeClassName);
    }
